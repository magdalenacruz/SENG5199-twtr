...
class AccountIntegrationSpec extends Specification {
    ...
    void "Non-Unique handle"() {
        ...
        Account badAccount = new Account(handle: 'groovyNewby', email: 'test@test.com', password: '1234567wE', name: 'Ron Weasley')
        !badAccount.save()
    }
    ...
    void "Non-Unique email"() {
        ...
        Account badAccount = new Account(handle: 'Weasel', email: 'newb@groovy.com', password: '1234567wE', name: 'Ron Weasley')
        !badAccount.save()
    }
